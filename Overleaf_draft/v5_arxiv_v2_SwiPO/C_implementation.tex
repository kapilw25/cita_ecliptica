...
All methods branch from the same SFT initialization; \textsc{DPO}/SwiPO then apply offline preference optimization, while \textsc{PPO}/\textsc{GRPO} run on-policy updates.
