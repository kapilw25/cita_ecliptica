...
\begin{itemize}[leftmargin=*,itemsep=2pt]
    \item \textbf{A. Related Works \& SwiPO Loss Derivation}: Full mathematical derivation and gradient analysis (cf.~\cref{sec:appendix_related}, \cref{sec:appendix_cita_kl})
    \item \textbf{B. Training Pipeline Diagrams}: Detailed architectures for SFT, DPO, PPO, GRPO, SwiPO (cf.~\cref{sec:appendix_pipelines})
    ...
    \item \textbf{I. Discussion Figures \& Tables}: Toolbox, claims map, and at-a-glance tables (cf.~\cref{sec:appendix_discussion_floats})
\end{itemize}
